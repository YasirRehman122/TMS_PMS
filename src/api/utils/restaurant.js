...
class RestaurantUtils extends CommonUtils{
    ...
    validateCreateRestaurantParams(data){
        ...
        const requiredParams = ['shopName', 'licenseNo', 'ownerName', 'orderQueueSize', 'latitude', 'longitude', 'catId'];
    ...
    validateAddIngredientsParams(data){
        ...
        const requiredParams = ['providerID','itemID','ingredients','optionalIngredients'];
    ...
    validateSavePendingFeedbackParams(data){

        const requiredParams = ['providerID', 'userID', 'orderID'];
    ...
    validateSavePendingFeedbackAgainParams(data){

        const requiredParams = ['providerID', 'userID', 'orderID', 'review', 'rating'];
    ...
    validateGetPendingFeedbackParams(data){
    ...
    validateUpdateQueueParams(data){
